...
export default function Modal({ close }: { close: () => void }) {
  return (
    <div className="w-screen h-screen absolute bg-slate-400 bg-opacity-70 p-20 border-2 border-green-500 ">
      <div className="bg-white h-full  border-2 border-red-500 p-10">
